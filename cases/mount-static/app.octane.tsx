// cases/mount-static/app.octane.tsx — Octane variant of app.tsx.
// Same tree, same class literals, same text; no state. Keys are positional
// because the tree never changes.
