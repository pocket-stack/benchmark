// cases/soak-churn/app.octane.tsx — Octane variant of app.tsx.
// Same cadence, same rows; useFrame drives the loop and writes component
// state through the setter the component hands to module scope.
...
function churnFrame(): void {
  if (!running || !setExternal) return;
  setExternal(step % 2 === 0 ? makeRows(ROW_COUNT) : []);
  step += 1;
