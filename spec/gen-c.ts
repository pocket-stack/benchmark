...
/** 段 id：与 vendor/pocketjs/hosts/soft/pocket_runtime.h 的 POCKET_BENCH_STAGE_* 同值，再加三个 shell 自己的段。 */
export const STAGES = [
  ["IDLE", 0],
  ["EVAL", 1],
  ["JS", 2],
...
/**
 * pocket_runtime.c 实际调用的 C ABI（vendor/pocketjs/hosts/soft/pocket_core.h）。键是 spec OP 名；
